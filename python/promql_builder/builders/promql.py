...
"""
def clamp(v: cogbuilder.Builder[promql.Expr], min_val: float, max_val: float) -> FuncCallExpr:
    builder = FuncCallExpr()
...
"""
def clamp_max(v: cogbuilder.Builder[promql.Expr], max_val: float) -> FuncCallExpr:
    builder = FuncCallExpr()
...
"""
def clamp_min(v: cogbuilder.Builder[promql.Expr], min_val: float) -> FuncCallExpr:
    builder = FuncCallExpr()
...
def label_eq(name: str, value: str) -> LabelSelector:
    ...
    builder.name(name)
    builder.value(value)
    builder.operator(promql.LabelMatchingOperator.EQUAL)
...
def label_neq(name: str, value: str) -> LabelSelector:
    ...
    builder.name(name)
    builder.value(value)
    builder.operator(promql.LabelMatchingOperator.NOT_EQUAL)
...
def label_match_regexp(name: str, value: str) -> LabelSelector:
    ...
    builder.name(name)
    builder.value(value)
    builder.operator(promql.LabelMatchingOperator.MATCH_REGEXP)
...
def label_not_match_regexp(name: str, value: str) -> LabelSelector:
    ...
    builder.name(name)
    builder.value(value)
    builder.operator(promql.LabelMatchingOperator.NOT_MATCH_REGEXP)
